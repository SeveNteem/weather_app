            ...
            return ListView.separated(
                ...
                itemBuilder: (context, i) {
                  return Dismissible(
                    ...
                    onDismissed: (DismissDirection direction) {model.deleteFavorite(i);},
                  );
                },
...
class FavoriteCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      color: AppColors.weatherList.withOpacity(0.6),
      child: Padding(
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            Text(
              '${value.getAt(index)?.temperature}',
              style: AppStyle.fontStyle.copyWith(
                  fontSize: 48, fontWeight: FontWeight.w500, height: 86 / 86),
            ),
            Text(
              '°C',
              style: AppStyle.fontStyle
